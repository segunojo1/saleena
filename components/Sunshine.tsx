...
const Sunshine = () => {
  return (
    <div className="flex flex-col items-center mt-[56px] relative">
      <div className=" flex relative flex-col border-b-[1px] pb-10 items-center w-full">
        <Image
          src="/assets/mail.svg"
          width={113}
          height={113}
        ...
        <div className="flex relative justify-end mr-[50px]">
          ...
          <div className="flex flex-col z-[99999]  mr-[140px] gap-[30px] max-w-[559.2px] border-[#E5E5E5] bg-white rounded-2xl border-[0.5px] p-[23px] pb-[68px] font-neuemontreal text-[16px] font-medium">
            <span>
              ...
              in and fill it with light. You’ve always felt like the second kind
              to me.
            </span>
            <span>
              There&apos;s something about the way you exist that feels warm and
              easy, like sunlight through a window on a slow morning when the
              world hasn’t fully woken up yet. Not loud. Not overwhelming. Just
              gentle, steady warmth that makes everything feel a little softer.
            </span>
            <span>
              ...
              The quiet reassurance of knowing you’re there. It’s not something
              you try to do. It’s just who you are.
            </span>
            <span>
              And I think that’s what makes it so special. You shine without
              effort. You make ordinary days feel less ordinary. And being close
              to that kind of light — even from far away — feels like a gift I
              didn’t know I’d be lucky enough to receive.
            </span>
          </div>
        </div>
